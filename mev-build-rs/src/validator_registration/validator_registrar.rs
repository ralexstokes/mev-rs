...
use ethereum_consensus::{state_transition::{Context, Error as ConsensusError}, builder::SignedValidatorRegistration, primitives::BlsPublicKey};

use crate::verify_signed_builder_message;

use super::validator_summary_provider::{ValidatorSummaryProvider, Error as ValidatorsError};
use thiserror::Error;
